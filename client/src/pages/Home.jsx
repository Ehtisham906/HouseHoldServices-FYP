      ...
      <main >
        ...
        >
          <div className="flex flex-col items-center justify-center gap-y-5 py-40 ">
            <h1 className="text-white text-4xl  sm:font-normal text-center ">
              <span className='text-secondary '>Blockchain Based</span> Household Services
              <br />
            </h1>
        ...
        <section className="mt-40  mx-6 flex flex-col gap-20 ">
          ...
          <div className="  flex flex-wrap gap-y-9  items-center justify-around">
            ...
            <div className="py-10 sm:py-20 px-2 justify-center flex flex-col items-center rounded-md shadow-[0_10px_22px_rgba(29,_78,_216,_0.4)] w-full sm:w-[45%] text-center lg:w-[30%]  cursor-pointer sm:h-[350px]">
              ...
              <div>
                <p className="text-sm sm:text-base">
                  <span className=" text-primary">Document Localization:</span> translation, editing, proofreading, and quality checks.
                  <br />
                  <span className=" text-primary">Audiovisual Localization: </span> translation, AI-assisted audio/video production, and quality checks.
                </p>
              </div>
            </div>
