        ...
        <footer className="bg-red-200 mt-[60px]">
                ...
                <div className=" flex flex-col gap-3 sm:gap-10 contactDetails">
                    ...
                    <div className="flex gap-3">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path fillRule="evenodd" clipRule="evenodd" d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="#202124" />
                            </svg>
                        </div>
                        <div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div>
                            ...
                            <span className="font-thin text-sm sm:font-normal">real-estate@xyz.com</span>
                        </div>
                    </div>
            ...
            <div className="flex justify-center">
                <div className="mx-auto">
                    ...
                    <span className="font-thin text-sm sm:font-normal">&#169; 2024 EAM</span>
                </div>
                <div className="mx-auto">
